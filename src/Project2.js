    ...
    return(
        <>
            <div className="flex topMargin">
                <img src="https://www.augustinaliu.com/wp-content/uploads/2020/01/Frame-8.png" className="half"/>
                <div  className="half">
                    <p className="mainTitle">Best coworking space for freelancers and remote workers</p>
